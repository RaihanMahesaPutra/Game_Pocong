var sceneMenu = new Phaser.Class({
    ...
    create(){
        ...
        // Membuat animasi untuk sprite "sps_nummy" dengan frame rate 16
        const numpyAnimation = this.anims.create({
            frames: this.anims.generateFrameNumbers("sps_nummy"),
            frameRate: 16,
        });

        // Menambahkan sprite ke scene pada posisi (570, 534), mengatur skala, dan memainkan animasi "walk" secara berulang
        const sprite = this.add.sprite(570, 768 / 2 + 150, "sps_nummy").setScale(d).setDepth(10);
