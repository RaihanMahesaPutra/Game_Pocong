var sceneMenu = new Phaser.Class({
    ...
    create(){
        ...
        var btnPlay = this.add.image(X_POSITION.CENTER, Y_POSITION.BOTTOM -120, "btn_play");
        btnPlay.setDepth(10);
        ...
        // Tambahkan sprite mummy dan sembunyikan awalnya
        const mummySprite = this.add.sprite(850, 768 / 2 + 145, "sps_mummy");
        mummySprite.setScale(0); // Skala awal = 0 (tak terlihat)
        mummySprite.setDepth(10);
        mummySprite.play('mummy_walk');

        // Animasi muncul seperti tombol play
        this.tweens.add({
            targets: mummySprite,
            ease: 'Back',
            duration: 500,
            delay: 1250, // Setelah tombol Play muncul
            scaleX: 4,
            scaleY: 4
        });
