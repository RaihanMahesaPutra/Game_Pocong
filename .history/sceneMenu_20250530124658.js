var sceneMenu = new Phaser.Class({
    ...
    enemyHitTop(enemy, boundary) {
    console.log('Enemy mentok di atas!');
    
    // Opsi 1: Balik arah dengan velocity
    enemy.body.setVelocityY(Math.abs(enemy.body.velocity.y));
    
    // Opsi 2: Destroy enemy
    // enemy.destroy();
    
    // Opsi 3: Reset posisi enemy
    // enemy.y = game.canvas.height + 50;
    
    // Opsi 4: Efek khusus ketika mentok
    this.add.particles(enemy.x, enemy.y, 'particle_texture', {
    ...
    // Play sound effect
    // this.sound.play('enemy_hit_sound');
}
    update(){}
});